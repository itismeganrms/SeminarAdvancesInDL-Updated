...
parser.add_argument("--data_dir", default="/data1/courses/2024-2025/4343SADL6/Tumor_Group/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData", type=str, help="dataset directory")
parser.add_argument("--json_list", default="/data1/courses/2024-2025/4343SADL6/Tumor_Group/SeminarAdvancesInDL/ALICE_Code/SiNGR-tumor/workdir/datasets/cv_split_5folds_brats_56789.pkl", type=str, help="dataset json file")
...
parser.add_argument("--optim_name", default="adambasedirw", type=str, help="optimization algorithm")
