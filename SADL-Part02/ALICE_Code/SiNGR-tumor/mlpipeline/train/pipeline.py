...
class DummyDataset(Dataset):
    def __init__(self, num_samples=100, channels=3, height=256, width=256, num_classes=2):
    ...
    def __getitem__(self, idx):
        ...
        target = torch.randint(0, self.num_classes, (self.height, self.width), dtype=torch.long)
...
class MLPipeline:
    ...
    def init_loaders(self):
        ...
        train_loader = torch.utils.data.DataLoader(train_ds, batch_size=1, num_workers=0)
    ...
    def train(self):
        ...
        for self.epoch in range(self.cfg.train.num_epochs):
            ...
            wandb_loss = train_loss.item() #/ self.cfg.data.batch_size
            ## wandb.log({"train_loss": wandb_loss})
