...
def transform_geo_dist(dist, gt, label_name):
    ...
    def transform_geo_dist_layer(dist_layer, gt_layer):
    ...
    # Loop over segmentation channels (label types)
    for ch in range(gt.shape[-1]):
        for z in range(dist.shape[-1]):
            dist[:, :, z] = transform_geo_dist_layer(dist[:, :, z], gt[:, :, z, ch])
...
@click.option("--root_dir", default="/data1/courses/2024-2025/4343SADL6/Tumor_Group/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData")
@click.option("--gt_dir", default="/data1/courses/2024-2025/4343SADL6/Tumor_Group/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData")
@click.option("--output_dir", default="/data1/courses/2024-2025/4343SADL6/Tumor_Group/Datasets/BraTS_UpdatedGT_OP")
