import sys
sys.path.append("/data1/courses/2024-2025/4343SADL6/Tumor_Group/GeodisTK")
...
def get_geodesic_distance(img_path, seg, nb_classes=1, dataset='BraTS', lamb=0.5):
...
def generate_geodesic_maps(method, mode, dataset='FLARE', nb_classes=1, data_path='', output_path=''):
    ...
    for img_index, img_name in enumerate(os.listdir(data_path)):
        ...
        flair_path = os.path.join(data_path, img_name, img_name + "_flair.nii")
        t1ce_path = os.path.join(data_path, img_name, img_name + "_t1ce.nii")
        t1_path = os.path.join(data_path, img_name, img_name + "_t1.nii")
        t2_path = os.path.join(data_path, img_name, img_name + "_t2.nii")
        seg_path = os.path.join(data_path, img_name, img_name + "_seg.nii")
        ...
        if method == 'ug':
            ...
            # seg_gd = get_geodesic_distance(seg, seg, nb_classes, dataset)
...
if __name__ == "__main__":
    ...
    output_root = Path("/data1/courses/2024-2025/4343SADL6/Tumor_Group/Datasets/Updated_GT")
    root_dir = "/data1/courses/2024-2025/4343SADL6/Tumor_Group/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData" #Replace with the actual path
