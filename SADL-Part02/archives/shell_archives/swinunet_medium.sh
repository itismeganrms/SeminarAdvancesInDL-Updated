...
#SBATCH --output=/data1/courses/2024-2025/4343SADL6/Tumor_Group/slurm/swinunet/new_train/output%A.out
...
CUDA_LAUNCH_BLOCKING=1 python simple_unet_run.py --data_dir /data1/courses/2024-2025/4343SADL6/Tumor_Group/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData --max_epochs 2 --batch_size 1 --fold 2