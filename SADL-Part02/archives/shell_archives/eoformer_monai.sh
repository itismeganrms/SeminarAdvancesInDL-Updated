...
#SBATCH --job-name=eo_monai
#SBATCH --time=04:00:00
#SBATCH --partition=gpu-short
#SBATCH --output=/data1/courses/2024-2025/4343SADL6/Tumor_Group/slurm/eoformer/final/eo_monai_output%A.out
#SBATCH --gres=gpu:1
