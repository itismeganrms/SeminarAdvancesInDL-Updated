...
def run_transformation(label_name, dataset, root_dir, gt_dir, output_dir):
    ...
    for si, sub_dir in enumerate(sub_dirs):
        ...
        for path in paths:
            ...
            geo_gt = torch.tensor(raw_geo_gt, device=device)
...
@click.option("--root_dir", default="../utils/data/MICCAI_BraTS2020_TrainingData")
@click.option("--gt_dir", default="../utils/data/MICCAI_BraTS2020_TrainingData")
@click.option("--output_dir", default="../utils/data/MICCAI_BraTS2020_TrainingData")
def main(label_name: str, dataset: str, root_dir: str, gt_dir: str, output_dir: str):
    ...
    print(f"ground_truth_directory: {gt_dir}")
